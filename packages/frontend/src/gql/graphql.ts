...
export type ShopCartQueryQuery = { __typename?: 'Query', cart?: { __typename?: 'ShopCart', id: string, userId: string, totalUnits: number, totalAmount: number, items: Array<{ __typename?: 'ShopCartItem', quantity: number, product: { __typename?: 'ShopCartItemProduct', id: number, title: string, price: number, image: string } }> } | null };

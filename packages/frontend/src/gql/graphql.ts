...
export type AddProductToCartMutation = { __typename?: 'Mutation', addProductToCart?: { __typename?: 'ShopCart', id: string, userId: string, items: Array<{ __typename?: 'ShopCartItem', quantity: number, product: { __typename?: 'ShopCartItemProduct', title: string, price: number } }> } | null };

export type ShopCartQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type ShopCartQueryQuery = { __typename?: 'Query', cart?: { __typename?: 'ShopCart', id: string, totalUnits: number, totalAmount: number, items: Array<{ __typename?: 'ShopCartItem', quantity: number, product: { __typename?: 'ShopCartItemProduct', id: number, title: string, price: number, image: string } }> } | null };
...
export type RemoveCartItemMutation = { __typename?: 'Mutation', removeProductFromCart?: { __typename?: 'ShopCart', id: string, totalUnits: number, totalAmount: number, items: Array<{ __typename?: 'ShopCartItem', quantity: number, product: { __typename?: 'ShopCartItemProduct', id: number, title: string, price: number, image: string } }> } | null };

export type CheckoutMutationMutationVariables = Exact<{ [key: string]: never; }>;


export type CheckoutMutationMutation = { __typename?: 'Mutation', checkout: string };

export type LayoutDataQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type LayoutDataQueryQuery = { __typename?: 'Query', categories: Array<{ __typename?: 'Category', code: string }>, cart?: { __typename?: 'ShopCart', totalUnits: number } | null };
...
export const ShopCartQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ShopCartQuery"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"cart"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"totalUnits"}},{"kind":"Field","name":{"kind":"Name","value":"totalAmount"}},{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"quantity"}},{"kind":"Field","name":{"kind":"Name","value":"product"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"price"}},{"kind":"Field","name":{"kind":"Name","value":"image"}}]}}]}}]}}]}}]} as unknown as DocumentNode<ShopCartQueryQuery, ShopCartQueryQueryVariables>;
export const RemoveCartItemDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RemoveCartItem"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"productId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"removeProductFromCart"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"productId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"productId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"totalUnits"}},{"kind":"Field","name":{"kind":"Name","value":"totalAmount"}},{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"quantity"}},{"kind":"Field","name":{"kind":"Name","value":"product"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"price"}},{"kind":"Field","name":{"kind":"Name","value":"image"}}]}}]}}]}}]}}]} as unknown as DocumentNode<RemoveCartItemMutation, RemoveCartItemMutationVariables>;
export const CheckoutMutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CheckoutMutation"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"checkout"}}]}}]} as unknown as DocumentNode<CheckoutMutationMutation, CheckoutMutationMutationVariables>;
